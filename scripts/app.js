                ...
                .state("dashboard.umkm", {
                    ...
                    resolve: {
                        loadMyFiles: function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: "ngAdmin",
                                files: ["scripts/controllers/umkm.js"]
                            });
                        }
                    }
                })
                .state("dashboard.coa", {
                    ...
                    resolve: {
                        loadMyFiles: function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: "ngAdmin",
                                files: ["scripts/controllers/coa.js"]
                            });
                        }
                    }
                })
                .state("dashboard.jurnal", {
                    ...
                    resolve: {
                        loadMyFiles: function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: "ngAdmin",
                                files: ["scripts/controllers/jurnal.js"]
                            });
                        }
                    }
                })
                .state("dashboard.tutup-buku", {
                    ...
                    resolve: {
                        loadMyFiles: function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: "ngAdmin",
                                files: ["scripts/controllers/tutup_buku.js"]
                            });
                        }
                    }
                })
                .state("dashboard.laporan-jurnal", {
                    ...
                    resolve: {
                        loadMyFiles: function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: "ngAdmin",
                                files: ["scripts/controllers/laporan_jurnal.js"]
                            });
                        }
                    }
                })
